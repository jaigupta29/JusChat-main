...
import com.example.juschat.ChatEvent
import com.example.juschat.DateHeader
import com.example.juschat.Message
import com.example.juschat.R
import com.example.juschat.utils.EncryptMessages
import com.example.juschat.utils.formatAsTime
...
class ChatAdapter(private val list: MutableList<ChatEvent>, private val mCurrentUser: String) :
    ...
    val decryptObj = EncryptMessages()
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (val item = list[position]) {
            ...
            is Message -> {
                val d =  EncryptMessages.decrypt(item.msg)
                holder.itemView.content.text = d
