...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun startUpload(filePath: Uri) {
        ...
        val storageReference :StorageReference = storage.getReferenceFromUrl("gs://juschat-81dad.appspot.com")
        val ref = storageReference.child("uploads/" + auth.uid.toString())
